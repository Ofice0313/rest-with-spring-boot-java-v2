...
public interface PersonControllerDocs {
    ...
    @Operation(
        summary = "Find a Person", description = "Find a specific person by your ID",
        tags = {"People"},
        responses = {
            @ApiResponse(
    ...
    @Operation(
        ...
        description = "Updates person's information by passing in JSON, XML or YML representation of the updates.",
        tags = {"People"},
        responses = {
            @ApiResponse(description = "No Content", responseCode = "204", content = @Content),
            @ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
